      ...
      >
        ...
        >
          <svg width="46" height="46" viewBox="0 0 46 46" fill="none">
            ...
            <line x1="12" y1="12" x2="34" y2="34" stroke="white" strokeWidth="2.5" strokeLinecap="round" />
            <line x1="12" y1="12" x2="34" y2="12" stroke="white" strokeWidth="2" strokeLinecap="round" strokeOpacity="0.7" />
          </svg>
        </div>
      </div>
...
function FeaturePill({ icon, label }: { icon: React.ReactNode; label: string }) {
  return (
    <div className="flex h-[45px] items-center gap-[10px] rounded-[30px] border border-coral-50 bg-white py-[3px] pl-[3px] pr-[22px]">
      ...
      <span className="whitespace-nowrap font-figtree text-[12px] text-[#221c19]">{label}</span>
    </div>
  );
}
...
function ShieldIcon() {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#f24e29" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
  ...
  return (
    <section className="bg-white py-[80px]">
      <div className="mx-auto max-w-7xl px-6 sm:px-8">
        <div className="flex flex-col items-center gap-16 lg:flex-row lg:items-center lg:gap-[140px]">

          {/* Left: copy */}
          <div className="flex flex-col gap-6 lg:max-w-[545px]">
            <span className="inline-flex w-fit items-center rounded-[28px] bg-linear-to-r from-coral-500/15 to-coral-500/0 px-3.5 py-2 font-figtree text-lg font-semibold text-coral-500">
              Why it matters
            </span>

            <h2
              className="font-fraunces text-[40px] font-bold leading-[1.08] sm:text-[48px]"
              style={{ fontVariationSettings: '"SOFT" 0, "WONK" 1' }}
            >
              <span className="text-coral-500">One name, everywhere </span>
              <span className="text-[#2e0d05]">people look </span>
            </h2>

            <p className="max-w-[660px] font-figtree text-[19px] leading-normal text-[#6b5f57]">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <FeaturePill icon={<GlobeIcon />} label="Connects to everything" />
            </div>
          </div>
