...
const STEPS = [
  ...
  },
  {
    ...
    description:
      "Pages, words, layout and images — ready in minutes. No blank page.",
  ...
  },
  {
    ...
    description:
      "Swap photos, change words, add pages. No code, nothing to break.",
  ...
  },
  {
    ...
    description:
      "Your site goes live instantly, free, with SSL included automatically.",
...
function ArrowEntry({ className }: { className?: string }) {
  ...
  return (
    ...
    >
      ...
      <polygon ref={headRef} points="122,287 133,275 140,294" fill="#F26B45" />
    </svg>
  );
}
...
function ArrowRight({ className }: { className?: string }) {
  ...
  return (
    ...
    >
      ...
      <polygon ref={headRef} points="141,31 143,15 160,20" fill="#F26B45" />
    </svg>
  );
}
...
export function HowItWorks() {
  return (
    <section className="relative w-full overflow-hidden bg-white">
      <Bounded className="flex-col items-center gap-12">
        {/* Header */}
            ...
            {STEPS.map((step) => (
              <div key={step.number} className="flex flex-col gap-6 z-20">
                ...
                <div className="rounded-2xl bg-[#faf6ef] p-6 sm:p-8">
                  <div
                    className={`flex flex-col gap-8 lg:flex-row lg:gap-2.5 ${step.cardAlign}`}
                  >
                    <div className="flex min-w-0 flex-1 flex-col gap-6">
                      <Badge text={step.badge} className="w-fit" />
