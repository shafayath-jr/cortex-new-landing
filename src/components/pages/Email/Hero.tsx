...
export function EmailHero() {
  return (
    <section className="relative w-full overflow-hidden bg-white">
      ...
      <Bounded className="relative flex items-center justify-between gap-1">
        {/* Left: copy */}
        <div className="flex flex-col gap-8 lg:max-w-[720px]">
          ...
          <p className="max-w-[630px] font-figtree text-[19px] leading-[1.5] text-[#6b5f57]">
            ...
            <strong className="font-bold text-[#2e0d05]">
              hello@yourbakery.com
            </strong>{" "}
